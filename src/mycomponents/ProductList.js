...
export default function ProductList() {
  return (
    ...
    <div className='items' id='k1'>
        ...
        <div className='itwo'><span className='min' onClick={()=>{pricedown('k1')}} onMouseOut={foot}>-</span><span className='quan'>0</span><span className='max' onClick={()=>{priceup('k1')}} onMouseOut={foot}>+</span></div>
        <div className='ithree'>0</div>
        <div className='ifour' onClick={()=>{remove('k1')}} onMouseOver={foot}>Remove</div>
    </div>
    <div className='items' id='k2'>
        <div className='ione'>Samsung Galaxy S11<span className='span'>150000</span></div>
        <div className='itwo'><span className='min' onClick={()=>{pricedown('k2')}} onMouseOut={foot}>-</span><span className='quan'>0</span><span className='max' onClick={()=>{priceup('k2')}} onMouseOut={foot}>+</span></div>
        <div className='ithree'>0</div>
        <div className='ifour' onClick={()=>{remove('k2')}} onMouseOver={foot}>Remove</div>
    </div>
    </div>
...
function adding (){
    ...
    ch23.className='max';
    ch21.innerHTML='-';
    ch21.onclick=()=>{pricedown(str1)};
    ch21.onmouseout=foot;
    ch22.innerHTML=0;
    ch23.innerHTML='+';
    ch23.onclick=()=>{priceup(str1);};
